...
export default function Project({
  ...
  return (
    ...
    >
      <section className="group relative  max-w-[42rem] overflow-hidden border border-black/5 bg-gray-400 transition  even:pl-8 hover:bg-gray-200  sm:h-[20rem] sm:pr-8">
